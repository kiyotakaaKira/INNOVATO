  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-violet-500/6 rounded-full blur-3xl" />
      ...
      <main className="lg:pl-72 pt-16 lg:pt-0 min-h-screen relative z-10">{children}</main>
    </div>
  )
}
