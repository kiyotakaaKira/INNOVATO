    ...
    <div className="min-h-screen p-4 lg:p-8">
      ...
      <div className="max-w-4xl mx-auto mb-8">
        ...
        <div className="flex items-center gap-3 mb-2">
          <motion.div
            className="p-2 rounded-xl bg-gradient-to-br from-indigo-500/20 to-violet-500/20 border border-indigo-500/30"
      ...
      <div className="max-w-4xl mx-auto mb-12">
        <div className="relative flex items-center justify-between">
          ...
          <motion.div
            className="absolute top-5 left-0 h-1 bg-gradient-to-r from-indigo-500 via-violet-500 to-indigo-500 rounded-full"
            initial={{ width: "0%" }}
              ...
              <div key={step.id} className="relative z-10 flex flex-col items-center">
                ...
                <span
                  className={`mt-2 text-xs font-medium ${
                    isCompleted || isCurrent ? "text-indigo-400" : "text-gray-500"
                  }`}
                >
                  {step.label}
                </span>
