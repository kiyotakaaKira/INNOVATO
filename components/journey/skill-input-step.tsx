...
const POPULAR_SKILLS = [
  ...
  { name: "AI & Machine Learning", icon: Brain, color: "from-indigo-500 to-violet-500" },
  ...
  { name: "Product Design", icon: Palette, color: "from-violet-500 to-rose-500" },
]
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <div className="relative p-8 md:p-12 rounded-2xl bg-gradient-to-br from-indigo-900/30 via-[#0a0a0f] to-violet-900/20 border border-indigo-500/30">
          {/* Grid Background */}
          <div
          ...
          <div className="relative z-10">
            ...
            <div className="text-center mb-10">
              <motion.div
                className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-500/20 border border-indigo-500/30 mb-4"
                animate={{ y: [0, -3, 0] }}
                transition={{ duration: 2, repeat: Number.POSITIVE_INFINITY }}
              >
                <Zap className="w-4 h-4 text-yellow-400" />
                <span className="text-sm text-indigo-300">STEP 1 OF 5</span>
            ...
            <div className="relative max-w-2xl mx-auto mb-10">
              <motion.div
                className={`absolute -inset-1 rounded-xl bg-gradient-to-r from-indigo-500 via-violet-500 to-blue-500 opacity-0 blur transition-opacity duration-300 ${
                  isFocused ? "opacity-50" : ""
                }`}
              />

              <div className="relative flex items-center">
                <Search className="absolute left-5 w-6 h-6 text-indigo-400" />
                <input
                  type="text"
                  value={inputValue}
                  ...
                  className="w-full pl-14 pr-6 py-5 rounded-xl bg-gray-900/80 border border-indigo-500/30 text-white text-lg placeholder:text-gray-500 focus:outline-none focus:border-indigo-500 transition-colors"
                />
              ...
              {POPULAR_SKILLS.map((skill, index) => {
                ...
                return (
                  ...
                  >
                    {isSelected && (
                      <motion.div
                        className="absolute -inset-px rounded-xl bg-gradient-to-r from-indigo-500 to-violet-500 opacity-20"
