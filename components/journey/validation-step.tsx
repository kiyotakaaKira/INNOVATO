    ...
    return (
      ...
      >
        ...
        <div className="relative w-32 h-32 mb-8">
          ...
          {/* Middle Ring */}
          <motion.div
            className="absolute inset-2 rounded-full border-4 border-dashed border-violet-500/30"
            animate={{ rotate: -360 }}
          ...
          {[...Array(3)].map((_, i) => (
            <motion.div
              key={i}
              className="absolute w-3 h-3 rounded-full bg-gradient-to-r from-indigo-500 to-violet-500"
        ...
        <div className="w-64 h-2 bg-gray-800 rounded-full overflow-hidden">
          <motion.div
            className="h-full bg-gradient-to-r from-indigo-500 via-violet-500 to-indigo-500 bg-[length:200%_200%]"
            initial={{ width: "0%" }}
            animate={{ width: "100%" }}
          ...
          <div className="relative z-10">
            ...
            <div className="text-center mb-10">
              ...
              >
                ...
                <span className="text-sm text-indigo-300">STEP 2 OF 5</span>
                ...
                <div className="flex flex-wrap justify-center gap-3">
                  {validation.alternatives.map((alt, index) => (
                    <motion.button
                      ...
                      className="px-6 py-3 rounded-xl bg-indigo-500/20 border border-indigo-500/30 text-indigo-300 hover:bg-indigo-500/30 hover:text-white transition-all"
