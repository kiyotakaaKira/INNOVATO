  ...
  return (
    ...
    >
      ...
      <div className="relative w-48 h-48 mb-12">
        {/* Background Glow */}
        <motion.div
          className="absolute inset-0 rounded-full bg-gradient-to-r from-indigo-500/30 via-violet-500/30 to-blue-500/30 blur-2xl"
        ...
        {/* Middle Ring */}
        <motion.div
          className="absolute inset-4 rounded-full border-4 border-dashed border-violet-500/40"
          animate={{ rotate: -360 }}
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <motion.div
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-indigo-500 via-violet-500 to-blue-500 p-[2px]"
        ...
        {AGENTS.map((agent, index) => {
          ...
          return (
            ...
            >
              ...
              <div className="relative flex items-center gap-4">
                <div
                  className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                    isCompleted ? "bg-green-500/20" : isCurrent ? "bg-indigo-500/30" : "bg-gray-800"
                  }`}
                >
                  {isCompleted ? (
              ...
              {isCurrent && (
                <motion.div
                  className="absolute bottom-0 left-0 h-1 bg-gradient-to-r from-indigo-500 to-violet-500 rounded-b-xl"
                  initial={{ width: "0%" }}
                  animate={{ width: "100%" }}
