...
const GOALS = [
  ...
  { id: "projects", label: "Build Projects", icon: Blocks, color: "from-indigo-500 to-violet-500" },
          ...
          <div className="relative z-10">
            ...
            <div className="text-center mb-10">
              ...
              >
                ...
                <span className="text-sm text-indigo-300">STEP 3 OF 5</span>
                ...
                {LEVELS.map((level, index) => {
                  ...
                  return (
                    ...
                    >
                      {isSelected && (
                        <motion.div
                          className="absolute inset-0 rounded-xl bg-gradient-to-r from-indigo-500/10 to-violet-500/10"
                ...
                {TIME_COMMITMENTS.map((time, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isSelected && (
                        <motion.div
                          className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-8 h-1 rounded-full bg-gradient-to-r from-indigo-500 to-violet-500"
                ...
                {GOALS.map((goal, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isSelected && (
                        <motion.div
                          className="absolute -top-1 -right-1 w-6 h-6 rounded-full bg-gradient-to-r from-indigo-500 to-violet-500 flex items-center justify-center"
                          initial={{ scale: 0 }}
                          animate={{ scale: 1 }}
                        >
